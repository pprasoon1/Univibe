...
const connectDB = async () => {
    try {
        ...
        const options = {
            ...
            useCreateIndex: true,         // Make Mongoose's default index creation mechanism more compatible with MongoDB
            useFindAndModify: false       // Deprecation warning for findAndModify
        };
